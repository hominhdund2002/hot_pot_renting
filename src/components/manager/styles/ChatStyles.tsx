...
export const MessageBubble = styled(Box, {
  ...
  // Different border radius for different senders
  borderTopLeftRadius: isStaff ? theme.spacing(2) : theme.spacing(0.5),
  borderTopRightRadius: isStaff ? theme.spacing(0.5) : theme.spacing(2),
